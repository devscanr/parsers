...
def describe_parse_phones() -> None:
    def parses_international_numbers() -> None:
    ...
    def parses_contextualized_numbers_unicode() -> None:
        assert parse_phones("☎ 5573558") == ["5573558"]
        assert parse_phones("📞5573558") == ["5573558"]
        assert parse_phones("☎️5573558") == ["5573558"]
        assert parse_phones("📱:5573558") == ["5573558"]

    def parses_contextualized_numbers_set1() -> None:
    ...
    def parses_contextualized_numbers_set2() -> None:
    ...
    def parses_contextualized_numbers_set3() -> None:
    ...
    def parses_contextualized_numbers_set4() -> None:
    ...
    def parses_contextualized_numbers_set5() -> None:
    ...
    def parses_contextualized_numbers_set6() -> None:
    ...
    def parses_contextualized_numbers_set7() -> None:
    ...
    def parses_contextualized_numbers_set8() -> None:
