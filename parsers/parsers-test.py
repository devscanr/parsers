...
def describe_parse_phones() -> None:
    ...
    def parses_set2() -> None:
        ...
        assert parse_phones("Phone : +94 769767692 || Email : mohamedalthaff@gmail.com || Phone +555") == ["+94769767692", "+555"]

    def parses_set3() -> None:
